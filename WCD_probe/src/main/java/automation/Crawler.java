...
public class Crawler
{
    ...
    public Crawler(String domain_input, String cookies_input)
    {
        ...
        domain = domain_input;  // Salva il dominio da analizzare
        
        
        // Usa WebDriverManager per scaricare e configurare il driver di Chrome
        ...
        // Visita l'URL per rimanere nel dominio e impostare i cookie
        driver.get("https://" + domain_input + "/something/inexistent/to/stay_on_domain/and_set_cookies");
    	//set the session cookies in the browser session
		System.out.println("cookies: " + cookies_input);
    ...
    **************************************************/
    ...
    public void getPageLinks(String URL_input, int depth) throws InterruptedException
    {
    	...
    	if(URL_input.startsWith("http://" + domain) || URL_input.startsWith("https://" + domain))		//if it's a valid URL
    	{
	    	...
	    	System.out.println("URL in input: " + URL_input);
